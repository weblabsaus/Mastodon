...
- **Add experimental server-side notification grouping** (#29889, #30576, #30685, #30688, #30707, #30776, #30779, #30781, #30440, #31062, #31098, #31076, #31111, #31123, #31223, #31214, #31224, #31299, #31325, #31347, #31304, #31326, #31384)
  ...
  TODO: documentation
- **Add notification policies, filtered notifications and notification requests** (#29366, #29529, #29433, #29565, #29567, #29572, #29575, #29588, #29646, #29652, #29658, #29666, #29693, #29699, #29737, #29706, #29570, #29752, #29810, #29826, #30114, #30251, #30559, #29868, #31008, #31011, #30996, #31149, #31220, #31222, #31225, #31242, #31262, #31250, #31273, #31310, #31316, #31322, #31329, #31324, #31331, #31343, #31342, #31309, #31358, #31378)
  ...
  - `POST /api/v1/notifications/requests/accept`: TODO doc for bulk
  - `POST /api/v1/notifications/requests/dismiss`: TODO doc for bulk
...
- **Add hover cards in web UI** (#30754, #30864, #30850, #30879, #30928, #30949, #30948, #30931, #31300)
...
- Add moderation interface for searching hashtags (#30880)
- Add ability for admins to configure instance favicon and logo (#30040, #30208, #30259, #30375, #30734, #31016)
- Add recent audit log entries in federation moderation interface (#27386)
...
- Add support for PKCE in OAuth flow (#31129)
- Add CDN cache busting on media deletion (#31353)
- Add the OAuth application used in local reports (#30539)
...
- Add check for `Content-Length` in `ResponseWithLimitAdapter` (#31285)
- Add `Accept-Language` header to fetch preview cards in the server's default language (#31232)
- Add support for PKCE Extension in OmniAuth OIDC through the `OIDC_USE_PKCE` environment variable (#31131)
- Add API endpoints for unread notifications count (#31191)
  This adds the following REST API endpoints:
  - `GET /api/v1/notifications/unread_count`: https://docs.joinmastodon.org/methods/notifications/#unread-count
  - `GET /api/v2/notifications/unread_count`: TODO
...
- Add “Appeals” link under “Moderation” navigation category in moderation interface (#31071)
...
- Add Elasticsearch index size, ffmpeg and ImageMagick versions to the admin dashboard (#27301, #30710, #31130, #30845)
...
- Add groundwork for annual reports for accounts (#28693)
  This lays the groundwork for a “year-in-review”/“wrapped” style report for local users, but the is currently not in use.
...
- **Change icons throughout the web interface** (#27385, #27539, #27555, #27579, #27700, #27817, #28519, #28709, #28064, #28775, #28780, #27924, #29294, #29395, #29537, #29569, #29610, #29612, #29649, #29844, #27780, #30974, #30963, #30962, #30961, #31362, #31363)
...
- **Change design of confirmation modals in the web UI** (#29576, #29614, #29640, #29644, #30131, #30884)
...
- **Change background color throughout the web UI** (#29522, #29584, #29653, #29779, #29803, #29809, #29808, #29828, #31034, #31168, #31266, #31348, #31349, #31361)
...
- Change mute options to be in dropdown on muted users list in web UI (#30049, #31315)
...
- Change confirmation prompts in trending moderation interface to be more specific (#19626)
- Change “Trends” moderation menu to “Recommendations & Trends” and move follow recommendations there (#31292)
- Change irrelevant fields in account cleanup settings to be disabled unless automatic cleanup is enabled (#26562)
...
- Change link detection to allow `@` at the end of an URL (#31124)
...
- Change maximum page size for Admin Domain Management APIs from 200 to 500 (#31253)
...
- Fix various issues when in link preview card generation (#28748, #30017, #30362, #30173, #30853, #30929, #30933, #30957, #30987, #31144)
...
- Fix handling of missing links in Webfinger responses (#31030)
...
- Fix various cases of duplicate, missing, or inconsistent borders (#31068, #31286, #31268, #31275, #31284, #31305, #31346, #31372, #31373)
...
- Fix moderation report updates through `PUT /api/v1/admin/reports/:id` not being logged in the audit log (#29044, #30342, #31033)
